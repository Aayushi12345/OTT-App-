...
class _ProfileAccountScreenState extends State<ProfileAccountScreen> {
  ...
  ClearData() async {
    await SharedPreferencesService.clearData();
  }
  ...
  MyUserData() async {
    ...
    String? name =
        await SharedPreferencesService.getSingleString(Constant.NAME);
    String? password =
        await SharedPreferencesService.getSingleString(Constant.PASSWORD);
    String? gendar =
        await SharedPreferencesService.getSingleString(Constant.GENDAR);
                  ...
                  children: [
                    _image != null
                        ...
                        : CircleAvatar(
                            radius: 50, // Image radius
                            backgroundImage:
                                AssetImage(user.imgUrl.toString())),
